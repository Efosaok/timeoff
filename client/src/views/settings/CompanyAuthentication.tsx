...
const CompanyAuthentication = () => {
  const { res } = useCompanyAuthentication();
          ...
          <form className="form-horizontal" action="" method="post">
            ...
            <div className="form-group">
              ...
              <label htmlFor="ldap_auth_enabled" className="control-label">
                <input
                  ...
                  type="checkbox"
                  checked={res?.company?.ldap_auth_enabled}
            ...
            <div className="form-group">
              ...
              <div className="col-md-5">
                <input className="form-control" id="ldap_url" placeholder="ldap://ldap.forumsys.com:389" name="url" value={res?.ldap_config?.url} aria-describedby="ldap_url_help" />
              </div>
              ...
              <div className="col-md-9 col-md-offset-3">
                <label htmlFor="allow_unauthorized_cert" className="control-label">
                  <input
                    ...
                    type="checkbox"
                    checked={res?.ldap_config?.allow_unauthorized_cert}
            ...
            <div className="form-group">
              ...
              <div className="col-md-5">
                <input className="form-control" id="ldap_bindn" placeholder="cn=read-only-admin,dc=example,dc=com" name="binddn" value={res?.ldap_config?.binddn} />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="col-md-5">
                <input className="form-control" id="ldap_password" placeholder="" name="bindcredentials" value={res?.ldap_config?.bindcredentials} type="password" aria-describedby="ldap_password_help" />
              </div>
            ...
            <div className="form-group">
              ...
              <div className="col-md-5">
                <input className="form-control" id="ldap_search_base" placeholder="dc=example,dc=com" name="searchbase" value={res?.ldap_config?.searchbase} />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="col-md-5">
                <input className="form-control" id="current_user_password" placeholder="" name="password_to_check" value="" type="password" aria-describedby="current_user_password_help" />
              </div>
            ...
            <div className="form-group">
              <div className="col-md-offset-3 col-md-5">
                <button id="submit_registration" type="submit" className="pull-right btn btn-success single-click">Save LDAP configuration</button>
              </div>
            </div>
