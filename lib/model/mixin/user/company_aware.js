...
//	  console.log('I got here 15');
    var user_id    = args.user_id,
      year         = args.year || moment.utc(),
      current_user = this;

//	  console.log('I got here 15.1');
...
//	  .then(console.log('I got here 15.3, the company is: ' + company))
    // Make sure that company got only one user associated with for
    // provided user_id
    .then(function(company){

//console.log('I got here 15.4')
