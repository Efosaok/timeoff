...
LeaveDay.prototype.is_quarter_leave = function(){
  return String(this.day_part) === String(this.sequelize.models.Leave.leave_day_part_quarter());
};
...
LeaveDay.prototype.get_quarter_leave_type_id = function(){
  return String(this.quarter_leave_type_id);
};
